...
module.exports = {
  ...
  category: "Filter",
  usage: "speed <speed amount (0 - 20)>",
  aliases: ["customspeed", "changespeed", "cspeed"],

  description: "Changes the speed of the current song!", //the command description for Slash Command Overview
  cooldown: 5,
          ...
          return message.reply({
            embeds: [
              new MessageEmbed()
                ...
                .setFooter(ee.footertext, ee.footericon)
                .setTitle(
                  `${client.allEmojis.x} **Please add a speed amount between 0+ and 2!**`
                ),
            ],
          });
        }
        ...
        message.reply({
          embeds: [
            new MessageEmbed()
              ...
              .setTimestamp()
              .setTitle(
                `♨️ **Set the speed of the current song to ${speed_amount}!**`
              )
              .setFooter(
