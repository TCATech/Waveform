          ...
          return message.reply({
            embeds: [
              new MessageEmbed()
                ...
                .setFooter(ee.footertext, ee.footericon)
                .setTitle(
                  `${client.allEmojis.x} **Please add the position of the song you want to remove!**`
                )
                .setDescription(
                  `**Usage:**\n> \`${client.settings.get(
                    message.guild.id,
                    "prefix"
                  )}remove <SongPosition> [Amount]\``
                ),
            ],
          });
        }
          ...
          return message.reply({
            embeds: [
              new MessageEmbed()
                ...
                .setFooter(ee.footertext, ee.footericon)
                .setTitle(
                  `${client.allEmojis.x} **Please add the position of the song you wnat to remove as a NUMBER!**`
                )
                .setDescription(
                  `**Usage:**\n> \`${client.settings.get(
                    message.guild.id,
