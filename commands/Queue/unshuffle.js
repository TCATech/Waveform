...
module.exports = {
  ...
  description: "Un-shuffles the queue.", //the command description for Slash Command Overview
  cooldown: 10,
          ...
          return message.reply({
            embeds: [
              new MessageEmbed()
                .setColor(ee.wrongcolor)
                .setTitle(
                  `${client.allEmojis.x} **This queue has never been shuffled!**`
                ),
            ],
          });
        }
        ...
        message.reply({
          embeds: [
            new MessageEmbed()
              .setColor(ee.color)
              .setTimestamp()
              .setTitle(`🔀 **__Un__shuffled ${newQueue.songs.length} songs!**`)
              .setFooter(
