...
let os = require("os");
module.exports = {
  name: "bot", //the command name for execution & for helpcmd [OPTIONAL]
      ...
      cpuStat.usagePercent(function (e, percent, seconds) {
        try {
          ...
          const botinfo = new MessageEmbed()
            ...
            .addField(
              "🔊 Connections",
              `\`${connectedchannelsamount.toString()} Connections\``,
              true
            )
            .addField("\u200b", `\u200b`, true)
          ...
          const botinfo = new MessageEmbed()
            ...
            .setFooter(
              ...
              "https://cdn.discordapp.com/avatars/442355791412854784/a_d5591ce201b3018a7aa06c3f77d4b6f0.gif?size=512"
            );
          interaction.reply({
            embeds: [botinfo],
          });
