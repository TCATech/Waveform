...
module.exports = {
  ...
  description: "Goes backward in the song for X seconds.", //the command description for Slash Command Overview
  cooldown: 10,
  ...
  options: [
    ...
    //INFORMATIONS! You can add Options, but mind that the NAME MUST BE LOWERCASED! AND NO SPACES!!!, for the CHOCIES you need to add a array of arrays; [ ["",""] , ["",""] ]
    {
      Integer: {
        name: "seconds",
        description: "The amount of seconds you want to rewind to.",
        required: true,
      },
        ...
        interaction.reply({
          embeds: [
            new MessageEmbed()
              ...
              .setTimestamp()
              .setTitle(
                `⏩ **Went backwards in the song by \`${seekNumber} seconds\`!**`
              )
              .setFooter(
