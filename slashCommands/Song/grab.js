...
module.exports = {
  ...
  description:
    "Check some info about a specific song in a specific position in the queue.", //the command description for Slash Command Overview
  cooldown: 10,
    ...
    try {
      ...
      try {
        ...
        member
          ...
          .catch(() => {
            message.reply({
              content: `${client.allEmojis.x} **I can't DM you! Please turn on your DMs.**`,
            });
          });
      } catch (e) {
