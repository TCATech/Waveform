...
module.exports = {
  ...
  description: "Plays the current song from the beginning!", //the command description for Slash Command Overview
  cooldown: 10,
        ...
        interaction.reply({
          embeds: [
            new MessageEmbed()
              .setColor(ee.color)
              .setTimestamp()
              .setTitle(`🔃 **Playing the current song from the beginning!**`)
              .setFooter(
