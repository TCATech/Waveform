  ...
  options: [
    ...
    //{"Role": { name: "what_role", description: "To Ping a Role lol", required: false }}, //to use in the code: interacton.getRole("what_role")
    {
      String: {
        name: "filters",
        description:
          "All of the filters you want to remove. Add a space in between to remove multiple filters!",
        required: true,
      },
          ...
          return interaction.reply({
            embeds: [
              new MessageEmbed()
                ...
                .setFooter(ee.footertext, ee.footericon)
                .setTitle(
                  `${client.allEmojis.x} **You added at least one Filter, which is invalid!**`
                )
                .setDescription(
          ...
          return interaction.reply({
            embeds: [
              new MessageEmbed()
                ...
                .setFooter(ee.footertext, ee.footericon)
                .setTitle(
                  `${client.allEmojis.x} **You did not add a Filter, which is in the Filters.**`
                )
                .addField(
              ...
              .setTitle(
                `♨️ **Removed ${toRemove.length} ${
                  toRemove.length == filters.length
                    ? "Filters"
                    : `of ${filters.length} Filters! The Rest wasn't a part of the Filters yet!`
                }**`
              )
              .setFooter(
