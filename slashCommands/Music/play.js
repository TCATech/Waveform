...
module.exports = {
  ...
  description: "Plays a song or playlist in your voice channel!", //the command description for Slash Command Overview
  cooldown: 2,
  ...
  options: [
    ...
    //{"Integer": { name: "ping_amount", description: "How many times do you want to ping?", required: true }}, //to use in the code: interacton.getInteger("ping_amount")
    {
      String: {
        name: "query",
        description: "What song or playlist do you want to play?",
        required: true,
      },
        ...
        return interaction.reply({
          embeds: [
            new MessageEmbed()
              ...
              .setTitle(
                `<:declined:780403017160982538> Your voice channel is full, so I can't join!`
              ),
          ],
          ephemeral: true,
        });
