  ...
  options: [
    {
      StringChoices: {
        name: "mix",
        description: "What mix do you want to play?",
        required: true,
        choices: [
          ["Blues Mix", "blues"],
          ["Charts Mix", "charts"],
  ...
  run: async (client, interaction) => {
    try {
      ...
      if (args[0]) {
        ...
        if (args[0].toLowerCase().startsWith("n"))
          link = "https://open.spotify.com/playlist/7sZbq8QGyMnhKPcLJvCUFD";
        //pop
        if (args[0].toLowerCase().startsWith("p"))
          link = "https://open.spotify.com/playlist/37i9dQZF1DXc6IFF23C9jj";
        //default
        ...
        if (args[0].toLowerCase().startsWith("re"))
          link =
            "https://www.youtube.com/watch?v=NX7BqdQ1KeU&list=PLYUn4YaogdahwfEkuu5V14gYtTqODx7R2";
        //rock
        ...
        if (args[0].toLowerCase().startsWith("o"))
          link =
            "https://www.youtube.com/watch?v=iFOAJ12lDDU&list=PLYUn4YaogdahPQPTnBGCrytV97h8ABEav";
        //gaming
        ...
        if (args[0].toLowerCase().startsWith("ma"))
          link =
            "https://www.youtube.com/watch?v=WvMc5_RbQNc&list=PLYUn4Yaogdagvwe69dczceHTNm0K_ZG3P";
        //metal
      ...
      await interaction.reply({
        content: `${client.allEmojis.loading} Loading the **'${
      ...
      try {
        ...
        interaction.editReply({
          content: `${
            queue?.songs?.length > 0 ? "👍 Loaded" : "🎶 Now Playing"
          }: the **'${args[0] ? args[0] : "Default"}'**`,
          ephemeral: true,
        });
      } catch (e) {
